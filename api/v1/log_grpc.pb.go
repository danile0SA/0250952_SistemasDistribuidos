...
const (
	Log_Produce_FullMethodName       = "/log.Log/Produce"
	Log_Consume_FullMethodName       = "/log.Log/Consume"
	Log_ConsumeStream_FullMethodName = "/log.Log/ConsumeStream"
	Log_ProduceStream_FullMethodName = "/log.Log/ProduceStream"
)
